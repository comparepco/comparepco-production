...
async function addPayments() {
  console.log('🧪 Adding test payment instructions...\n');
  ...
  try {
    // Use the existing partner ID from our check
    const partnerId = '939006e2-b68d-4404-bee8-926d440bcfa3'; // Test Transport Company
    
    console.log('📝 Adding payment instructions to existing partner...');
...
addPayments().catch(console.error); 