...
export default function PartnerAnalyticsPage() {
  ...
  const loadStats = async () => {
    try {
      ...
      const [vehicleRes, availableRes, maintenanceRes, bookingsRes, activeBookingsRes, staffRes, docsRes] =
        await Promise.all([
      ...
      const vehicles = vehicleRes.count || 0;
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">Track your business performance and metrics</p>
            </div>
          </div>
