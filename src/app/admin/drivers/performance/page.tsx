...
export default function DriversPerformancePage() {
  ...
  useEffect(() => {
    const loadData = async () => {
      ...
      try {
        ...
        const enriched = (driversData || []).map(driver => {
          const driverBookings = (bookingsData || []).filter(booking => 
    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400">Loading driver performance data...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <div className="max-w-7xl mx-auto p-6">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400">Monitor driver performance, earnings, and activity</p>
        </div>
