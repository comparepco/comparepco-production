-- Add more categories for partner support issues
...
ALTER TABLE chat_sessions ADD CONSTRAINT chat_sessions_category_check 
  CHECK (category IN ('technical', 'billing', 'account', 'vehicle', 'booking', 'payment', 'documentation', 'general', 'app', 'earnings', 'trips', 'support', 'driver', 'fleet', 'claims', 'maintenance', 'pricing', 'legal', 'marketing', 'analytics'));
